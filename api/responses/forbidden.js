...
module.exports = function forbidden(optionalData) {
  ...
  // Set status code and send response data.
    ...
    if (optionalData == "CSRF mismatch") {
      optionalData = "El formulario está vencido. Reintente el ingreso";
    }
    res.locals._csrf = req.csrfToken();
    return res.view('portal/login.ejs',{title:"Ingreso al Portal de Servicios",mensaje:optionalData});
  }
